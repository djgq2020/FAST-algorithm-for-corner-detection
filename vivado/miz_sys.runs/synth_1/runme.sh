...
HD_PWD='C:/Users/Dj/Desktop/vivado/miz_sys.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log miz_sys_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source miz_sys_wrapper.tcl

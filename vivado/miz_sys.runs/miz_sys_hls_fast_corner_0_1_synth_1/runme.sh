...
HD_PWD='C:/Users/Dj/Desktop/vivado/miz_sys.runs/miz_sys_hls_fast_corner_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log miz_sys_hls_fast_corner_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source miz_sys_hls_fast_corner_0_1.tcl

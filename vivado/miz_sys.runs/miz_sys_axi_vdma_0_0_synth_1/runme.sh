...
HD_PWD='C:/Users/Dj/Desktop/vivado/miz_sys.runs/miz_sys_axi_vdma_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log miz_sys_axi_vdma_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source miz_sys_axi_vdma_0_0.tcl

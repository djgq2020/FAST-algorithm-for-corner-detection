...
HD_PWD='C:/Users/Dj/Desktop/vivado/miz_sys.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log miz_sys_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source miz_sys_wrapper.tcl -notrace

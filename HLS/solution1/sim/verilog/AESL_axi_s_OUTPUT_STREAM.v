...
`define TV_OUT_OUTPUT_STREAM_TDATA "../tv/rtldatafile/rtl.hls_fast_corner.autotvout_OUTPUT_STREAM_V_data_V.dat"
`define EGRESS_STATUS_OUTPUT_STREAM_TDATA "../tv/stream_size/stream_egress_status_OUTPUT_STREAM_V_data_V.dat"
`define TV_OUT_OUTPUT_STREAM_TKEEP "../tv/rtldatafile/rtl.hls_fast_corner.autotvout_OUTPUT_STREAM_V_keep_V.dat"
`define EGRESS_STATUS_OUTPUT_STREAM_TKEEP "../tv/stream_size/stream_egress_status_OUTPUT_STREAM_V_keep_V.dat"
`define TV_OUT_OUTPUT_STREAM_TSTRB "../tv/rtldatafile/rtl.hls_fast_corner.autotvout_OUTPUT_STREAM_V_strb_V.dat"
`define EGRESS_STATUS_OUTPUT_STREAM_TSTRB "../tv/stream_size/stream_egress_status_OUTPUT_STREAM_V_strb_V.dat"
`define TV_OUT_OUTPUT_STREAM_TUSER "../tv/rtldatafile/rtl.hls_fast_corner.autotvout_OUTPUT_STREAM_V_user_V.dat"
`define EGRESS_STATUS_OUTPUT_STREAM_TUSER "../tv/stream_size/stream_egress_status_OUTPUT_STREAM_V_user_V.dat"
`define TV_OUT_OUTPUT_STREAM_TLAST "../tv/rtldatafile/rtl.hls_fast_corner.autotvout_OUTPUT_STREAM_V_last_V.dat"
`define EGRESS_STATUS_OUTPUT_STREAM_TLAST "../tv/stream_size/stream_egress_status_OUTPUT_STREAM_V_last_V.dat"
`define TV_OUT_OUTPUT_STREAM_TID "../tv/rtldatafile/rtl.hls_fast_corner.autotvout_OUTPUT_STREAM_V_id_V.dat"
`define EGRESS_STATUS_OUTPUT_STREAM_TID "../tv/stream_size/stream_egress_status_OUTPUT_STREAM_V_id_V.dat"
`define TV_OUT_OUTPUT_STREAM_TDEST "../tv/rtldatafile/rtl.hls_fast_corner.autotvout_OUTPUT_STREAM_V_dest_V.dat"

// ==============================================================
// File generated on Fri Mar 05 18:38:48 +0800 2021
...
`define AUTOTB_TVIN_INPUT_STREAM_V_data_V  "./c.hls_fast_corner.autotvin_INPUT_STREAM_V_data_V.dat"
`define AUTOTB_TVIN_INPUT_STREAM_V_keep_V  "./c.hls_fast_corner.autotvin_INPUT_STREAM_V_keep_V.dat"
`define AUTOTB_TVIN_INPUT_STREAM_V_strb_V  "./c.hls_fast_corner.autotvin_INPUT_STREAM_V_strb_V.dat"
`define AUTOTB_TVIN_INPUT_STREAM_V_user_V  "./c.hls_fast_corner.autotvin_INPUT_STREAM_V_user_V.dat"
`define AUTOTB_TVIN_INPUT_STREAM_V_last_V  "./c.hls_fast_corner.autotvin_INPUT_STREAM_V_last_V.dat"
`define AUTOTB_TVIN_INPUT_STREAM_V_id_V  "./c.hls_fast_corner.autotvin_INPUT_STREAM_V_id_V.dat"
`define AUTOTB_TVIN_INPUT_STREAM_V_dest_V  "./c.hls_fast_corner.autotvin_INPUT_STREAM_V_dest_V.dat"
`define AUTOTB_TVIN_OUTPUT_STREAM_V_data_V  "./c.hls_fast_corner.autotvin_OUTPUT_STREAM_V_data_V.dat"
`define AUTOTB_TVIN_OUTPUT_STREAM_V_keep_V  "./c.hls_fast_corner.autotvin_OUTPUT_STREAM_V_keep_V.dat"
`define AUTOTB_TVIN_OUTPUT_STREAM_V_strb_V  "./c.hls_fast_corner.autotvin_OUTPUT_STREAM_V_strb_V.dat"
`define AUTOTB_TVIN_OUTPUT_STREAM_V_user_V  "./c.hls_fast_corner.autotvin_OUTPUT_STREAM_V_user_V.dat"
`define AUTOTB_TVIN_OUTPUT_STREAM_V_last_V  "./c.hls_fast_corner.autotvin_OUTPUT_STREAM_V_last_V.dat"
`define AUTOTB_TVIN_OUTPUT_STREAM_V_id_V  "./c.hls_fast_corner.autotvin_OUTPUT_STREAM_V_id_V.dat"
`define AUTOTB_TVIN_OUTPUT_STREAM_V_dest_V  "./c.hls_fast_corner.autotvin_OUTPUT_STREAM_V_dest_V.dat"
`define AUTOTB_TVIN_rows  "./c.hls_fast_corner.autotvin_rows.dat"
`define AUTOTB_TVIN_cols  "./c.hls_fast_corner.autotvin_cols.dat"
`define AUTOTB_TVIN_threhold  "./c.hls_fast_corner.autotvin_threhold.dat"
`define AUTOTB_TVIN_INPUT_STREAM_V_data_V_out_wrapc  "./rtl.hls_fast_corner.autotvin_INPUT_STREAM_V_data_V.dat"
`define AUTOTB_TVIN_INPUT_STREAM_V_keep_V_out_wrapc  "./rtl.hls_fast_corner.autotvin_INPUT_STREAM_V_keep_V.dat"
`define AUTOTB_TVIN_INPUT_STREAM_V_strb_V_out_wrapc  "./rtl.hls_fast_corner.autotvin_INPUT_STREAM_V_strb_V.dat"
`define AUTOTB_TVIN_INPUT_STREAM_V_user_V_out_wrapc  "./rtl.hls_fast_corner.autotvin_INPUT_STREAM_V_user_V.dat"
`define AUTOTB_TVIN_INPUT_STREAM_V_last_V_out_wrapc  "./rtl.hls_fast_corner.autotvin_INPUT_STREAM_V_last_V.dat"
`define AUTOTB_TVIN_INPUT_STREAM_V_id_V_out_wrapc  "./rtl.hls_fast_corner.autotvin_INPUT_STREAM_V_id_V.dat"
`define AUTOTB_TVIN_INPUT_STREAM_V_dest_V_out_wrapc  "./rtl.hls_fast_corner.autotvin_INPUT_STREAM_V_dest_V.dat"
`define AUTOTB_TVIN_OUTPUT_STREAM_V_data_V_out_wrapc  "./rtl.hls_fast_corner.autotvin_OUTPUT_STREAM_V_data_V.dat"
`define AUTOTB_TVIN_OUTPUT_STREAM_V_keep_V_out_wrapc  "./rtl.hls_fast_corner.autotvin_OUTPUT_STREAM_V_keep_V.dat"
`define AUTOTB_TVIN_OUTPUT_STREAM_V_strb_V_out_wrapc  "./rtl.hls_fast_corner.autotvin_OUTPUT_STREAM_V_strb_V.dat"
`define AUTOTB_TVIN_OUTPUT_STREAM_V_user_V_out_wrapc  "./rtl.hls_fast_corner.autotvin_OUTPUT_STREAM_V_user_V.dat"
`define AUTOTB_TVIN_OUTPUT_STREAM_V_last_V_out_wrapc  "./rtl.hls_fast_corner.autotvin_OUTPUT_STREAM_V_last_V.dat"
`define AUTOTB_TVIN_OUTPUT_STREAM_V_id_V_out_wrapc  "./rtl.hls_fast_corner.autotvin_OUTPUT_STREAM_V_id_V.dat"
`define AUTOTB_TVIN_OUTPUT_STREAM_V_dest_V_out_wrapc  "./rtl.hls_fast_corner.autotvin_OUTPUT_STREAM_V_dest_V.dat"
`define AUTOTB_TVIN_rows_out_wrapc  "./rtl.hls_fast_corner.autotvin_rows.dat"
`define AUTOTB_TVIN_cols_out_wrapc  "./rtl.hls_fast_corner.autotvin_cols.dat"
`define AUTOTB_TVIN_threhold_out_wrapc  "./rtl.hls_fast_corner.autotvin_threhold.dat"
`define AUTOTB_TVOUT_OUTPUT_STREAM_V_data_V  "./c.hls_fast_corner.autotvout_OUTPUT_STREAM_V_data_V.dat"
`define AUTOTB_TVOUT_OUTPUT_STREAM_V_keep_V  "./c.hls_fast_corner.autotvout_OUTPUT_STREAM_V_keep_V.dat"
`define AUTOTB_TVOUT_OUTPUT_STREAM_V_strb_V  "./c.hls_fast_corner.autotvout_OUTPUT_STREAM_V_strb_V.dat"
`define AUTOTB_TVOUT_OUTPUT_STREAM_V_user_V  "./c.hls_fast_corner.autotvout_OUTPUT_STREAM_V_user_V.dat"
`define AUTOTB_TVOUT_OUTPUT_STREAM_V_last_V  "./c.hls_fast_corner.autotvout_OUTPUT_STREAM_V_last_V.dat"
`define AUTOTB_TVOUT_OUTPUT_STREAM_V_id_V  "./c.hls_fast_corner.autotvout_OUTPUT_STREAM_V_id_V.dat"
`define AUTOTB_TVOUT_OUTPUT_STREAM_V_dest_V  "./c.hls_fast_corner.autotvout_OUTPUT_STREAM_V_dest_V.dat"
`define AUTOTB_TVOUT_OUTPUT_STREAM_V_data_V_out_wrapc  "./impl_rtl.hls_fast_corner.autotvout_OUTPUT_STREAM_V_data_V.dat"
`define AUTOTB_TVOUT_OUTPUT_STREAM_V_keep_V_out_wrapc  "./impl_rtl.hls_fast_corner.autotvout_OUTPUT_STREAM_V_keep_V.dat"
`define AUTOTB_TVOUT_OUTPUT_STREAM_V_strb_V_out_wrapc  "./impl_rtl.hls_fast_corner.autotvout_OUTPUT_STREAM_V_strb_V.dat"
`define AUTOTB_TVOUT_OUTPUT_STREAM_V_user_V_out_wrapc  "./impl_rtl.hls_fast_corner.autotvout_OUTPUT_STREAM_V_user_V.dat"
`define AUTOTB_TVOUT_OUTPUT_STREAM_V_last_V_out_wrapc  "./impl_rtl.hls_fast_corner.autotvout_OUTPUT_STREAM_V_last_V.dat"
`define AUTOTB_TVOUT_OUTPUT_STREAM_V_id_V_out_wrapc  "./impl_rtl.hls_fast_corner.autotvout_OUTPUT_STREAM_V_id_V.dat"
`define AUTOTB_TVOUT_OUTPUT_STREAM_V_dest_V_out_wrapc  "./impl_rtl.hls_fast_corner.autotvout_OUTPUT_STREAM_V_dest_V.dat"
module `AUTOTB_TOP;
...
initial begin : generate_AESL_ready_cnt_proc
    ...
    initial begin : finish_simulation
        ...
        @ (posedge AESL_clock);
        @ (posedge AESL_clock);
    fp1 = $fopen("./rtl.hls_fast_corner.autotvout_OUTPUT_STREAM_V_data_V.dat", "r");
    fp2 = $fopen("./impl_rtl.hls_fast_corner.autotvout_OUTPUT_STREAM_V_data_V.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.hls_fast_corner.autotvout_OUTPUT_STREAM_V_data_V.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.hls_fast_corner.autotvout_OUTPUT_STREAM_V_data_V.dat\"!");
    else begin
        $display("Comparing rtl.hls_fast_corner.autotvout_OUTPUT_STREAM_V_data_V.dat with impl_rtl.hls_fast_corner.autotvout_OUTPUT_STREAM_V_data_V.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
    fp1 = $fopen("./rtl.hls_fast_corner.autotvout_OUTPUT_STREAM_V_keep_V.dat", "r");
    fp2 = $fopen("./impl_rtl.hls_fast_corner.autotvout_OUTPUT_STREAM_V_keep_V.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.hls_fast_corner.autotvout_OUTPUT_STREAM_V_keep_V.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.hls_fast_corner.autotvout_OUTPUT_STREAM_V_keep_V.dat\"!");
    else begin
        $display("Comparing rtl.hls_fast_corner.autotvout_OUTPUT_STREAM_V_keep_V.dat with impl_rtl.hls_fast_corner.autotvout_OUTPUT_STREAM_V_keep_V.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
    fp1 = $fopen("./rtl.hls_fast_corner.autotvout_OUTPUT_STREAM_V_strb_V.dat", "r");
    fp2 = $fopen("./impl_rtl.hls_fast_corner.autotvout_OUTPUT_STREAM_V_strb_V.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.hls_fast_corner.autotvout_OUTPUT_STREAM_V_strb_V.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.hls_fast_corner.autotvout_OUTPUT_STREAM_V_strb_V.dat\"!");
    else begin
        $display("Comparing rtl.hls_fast_corner.autotvout_OUTPUT_STREAM_V_strb_V.dat with impl_rtl.hls_fast_corner.autotvout_OUTPUT_STREAM_V_strb_V.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
    fp1 = $fopen("./rtl.hls_fast_corner.autotvout_OUTPUT_STREAM_V_user_V.dat", "r");
    fp2 = $fopen("./impl_rtl.hls_fast_corner.autotvout_OUTPUT_STREAM_V_user_V.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.hls_fast_corner.autotvout_OUTPUT_STREAM_V_user_V.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.hls_fast_corner.autotvout_OUTPUT_STREAM_V_user_V.dat\"!");
    else begin
        $display("Comparing rtl.hls_fast_corner.autotvout_OUTPUT_STREAM_V_user_V.dat with impl_rtl.hls_fast_corner.autotvout_OUTPUT_STREAM_V_user_V.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
    fp1 = $fopen("./rtl.hls_fast_corner.autotvout_OUTPUT_STREAM_V_last_V.dat", "r");
    fp2 = $fopen("./impl_rtl.hls_fast_corner.autotvout_OUTPUT_STREAM_V_last_V.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.hls_fast_corner.autotvout_OUTPUT_STREAM_V_last_V.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.hls_fast_corner.autotvout_OUTPUT_STREAM_V_last_V.dat\"!");
    else begin
        $display("Comparing rtl.hls_fast_corner.autotvout_OUTPUT_STREAM_V_last_V.dat with impl_rtl.hls_fast_corner.autotvout_OUTPUT_STREAM_V_last_V.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
    fp1 = $fopen("./rtl.hls_fast_corner.autotvout_OUTPUT_STREAM_V_id_V.dat", "r");
    fp2 = $fopen("./impl_rtl.hls_fast_corner.autotvout_OUTPUT_STREAM_V_id_V.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.hls_fast_corner.autotvout_OUTPUT_STREAM_V_id_V.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.hls_fast_corner.autotvout_OUTPUT_STREAM_V_id_V.dat\"!");
    else begin
        $display("Comparing rtl.hls_fast_corner.autotvout_OUTPUT_STREAM_V_id_V.dat with impl_rtl.hls_fast_corner.autotvout_OUTPUT_STREAM_V_id_V.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
    fp1 = $fopen("./rtl.hls_fast_corner.autotvout_OUTPUT_STREAM_V_dest_V.dat", "r");
    fp2 = $fopen("./impl_rtl.hls_fast_corner.autotvout_OUTPUT_STREAM_V_dest_V.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.hls_fast_corner.autotvout_OUTPUT_STREAM_V_dest_V.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.hls_fast_corner.autotvout_OUTPUT_STREAM_V_dest_V.dat\"!");
    else begin
        $display("Comparing rtl.hls_fast_corner.autotvout_OUTPUT_STREAM_V_dest_V.dat with impl_rtl.hls_fast_corner.autotvout_OUTPUT_STREAM_V_dest_V.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);

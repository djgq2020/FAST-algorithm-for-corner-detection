...
architecture behav of hls_fast_corner is 
    ...
    "hls_fast_corner,hls_ip_2018_3,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z010clg400-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=9.400000,HLS_SYN_LAT=-1,HLS_SYN_TPT=-1,HLS_SYN_MEM=61,HLS_SYN_DSP=3,HLS_SYN_FF=13759,HLS_SYN_LUT=16443,HLS_VERSION=2018_3}";
